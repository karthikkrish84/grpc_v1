...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.karthik.model.BalanceCheckRequest,
      com.karthik.model.Balance> getGetBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBalance",
      requestType = com.karthik.model.BalanceCheckRequest.class,
      responseType = com.karthik.model.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.karthik.model.BalanceCheckRequest,
      com.karthik.model.Balance> getGetBalanceMethod() {
    io.grpc.MethodDescriptor<com.karthik.model.BalanceCheckRequest, com.karthik.model.Balance> getGetBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetBalanceMethod = BankServiceGrpc.getGetBalanceMethod) == null) {
          BankServiceGrpc.getGetBalanceMethod = getGetBalanceMethod =
              io.grpc.MethodDescriptor.<com.karthik.model.BalanceCheckRequest, com.karthik.model.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.karthik.model.BalanceCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.karthik.model.Balance.getDefaultInstance()))
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getBalance(com.karthik.model.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.karthik.model.Balance> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.karthik.model.BalanceCheckRequest,
                com.karthik.model.Balance>(
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BankServiceBlockingStub> {
    ...
    /**
     */
    public com.karthik.model.Balance getBalance(com.karthik.model.BalanceCheckRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BankServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.karthik.model.Balance> getBalance(
        com.karthik.model.BalanceCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BALANCE:
          serviceImpl.getBalance((com.karthik.model.BalanceCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.karthik.model.Balance>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.karthik.model.BankServiceOuterClass.getDescriptor();
    }
